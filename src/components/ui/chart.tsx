  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-white/10 bg-black text-white px-2.5 py-1.5 text-xs shadow-xl',
          className
        )}
      >
                  ...
                  {formatter && item?.value !== undefined && item.name ? (
                    ...
                    <>
                      ...
                      >
                        <div className="grid gap-1.5">
                          {nestLabel ? tooltipLabel : null}
                          <span className="text-white/80">{itemConfig?.label || item.name}</span>
                        </div>
                        {item.value && (
