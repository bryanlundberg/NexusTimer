  ...
  return (
    <FadeIn className="flex flex-col grow overflow-auto">
      <div className="max-w-7xl mx-auto px-2 pt-2 flex flex-col w-full min-h-full">
        ...
        <div className={'grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 overflow-auto p-2'}>
          ...
          {!isLoading && filteredUsers.length > 0 && filteredUsers.map((user: UserDocument) => (
            <Card
              key={user._id}
              className="overflow-hidden transition-all duration-200 animate-fadeIn">
              <CardHeader className="pb-2 flex flex-col items-center">
