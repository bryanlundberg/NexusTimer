  ...
  return (
    <div className={'max-w-lg mx-auto py-10'}>
      ...
      <Li>
        ...
        language, type of operating system and geo location (only general location). Non-personal information is
        gathered by third party services while you are accessing the service. They are allowed to use this information
        to conduct research and analysis, but only for strictly limited purposes.
      </Li>

      <Li>
        Internally, NexusTimer also reserves the right to collect anonymous information for research and analysis. This
      ...
      <Li>
        ...
        hard drive for record-keeping purposes and sometimes to track information about them.
      </Li>
      ...
      <Li>
        Similarly, NexusTimer also uses non-personal information to conduct research and analysis. We do this to improve
        our services in future updates or to gain knowledge about how our users our interacting with the service.
      </Li>
      ...
      <Para>
        Under no other circumstances will NexusTimer share, sell, rent, or release your data. You may contact NexusTimer
      ...
      <Li>
        ...
        popularity of products/services and online activity. Additionally, we use this information for site
        optimization, fraud/security purposes, and advertising. For more information about how Microsoft collects and
        uses your data, visit the{' '}
        <Link href={'https://www.microsoft.com/es-mx/privacy/privacystatement'}>Microsoft Privacy Statement</Link>.
      </Li>
    </div>
  )
}
