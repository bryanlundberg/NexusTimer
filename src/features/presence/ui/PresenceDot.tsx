...
import type { PresenceView } from '@/features/presence/model/usePresence'
...
const SHAPES: Record<PresenceView, string> = {
  online: OUTER,
  away: `${OUTER} ${MOON_BITE}`,
  busy: `${OUTER} ${DND_BAR}`,
  offline: `${OUTER} ${RING_HOLE}`,
  unknown: `${OUTER} ${RING_HOLE}`
}

const COLORS: Record<PresenceView, string> = {
  online: 'text-emerald-500',
  away: 'text-amber-400',
  busy: 'text-red-500',
  offline: 'text-zinc-400 dark:text-zinc-500',
  unknown: 'text-zinc-300/70 dark:text-zinc-700'
}
