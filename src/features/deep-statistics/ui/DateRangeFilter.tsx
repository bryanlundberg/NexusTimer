...
export default function DateRangeFilter() {
  ...
  const [orderType, setOrderType] = useQueryState(STATES.SOLVES_PAGE.ORDER.KEY, {
    defaultValue: STATES.SOLVES_PAGE.ORDER.DEFAULT_VALUE
  })
  const [sortType, setSortType] = useQueryState(STATES.SOLVES_PAGE.SORT.KEY, {
    defaultValue: STATES.SOLVES_PAGE.SORT.DEFAULT_VALUE
  })
            ...
            <DropdownMenuPortal>
              <DropdownMenuSubContent>
                <DropdownMenuRadioGroup value={sortType} onValueChange={setSortType}>
                  <DropdownMenuRadioItem value="time">{t('SolvesPage.time')}</DropdownMenuRadioItem>
                  <DropdownMenuRadioItem value="date">{t('SolvesPage.date')}</DropdownMenuRadioItem>
                </DropdownMenuRadioGroup>
              </DropdownMenuSubContent>
            </DropdownMenuPortal>
          </DropdownMenuSub>
            ...
            <DropdownMenuPortal>
              <DropdownMenuSubContent>
                <DropdownMenuRadioGroup value={orderType} onValueChange={setOrderType}>
                  <DropdownMenuRadioItem value="asc">{t('SolvesPage.ascending')}</DropdownMenuRadioItem>
                  <DropdownMenuRadioItem value="desc">{t('SolvesPage.descending')}</DropdownMenuRadioItem>
                </DropdownMenuRadioGroup>
              </DropdownMenuSubContent>
            </DropdownMenuPortal>
          </DropdownMenuSub>
