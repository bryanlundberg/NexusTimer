...
export default function AlternativeRow({ alt, index, onPreview }: AlternativeRowProps) {
  return (
    <div className="notch-bl-tr flex items-start gap-2 border bg-background/40 px-2 py-1.5">
      ...
      <Button
        variant="ghost"
        size="icon"
        className="btn-notch size-6 shrink-0 text-muted-foreground hover:text-foreground"
        onClick={(e) => {
          e.stopPropagation()
          onPreview()
        }}
