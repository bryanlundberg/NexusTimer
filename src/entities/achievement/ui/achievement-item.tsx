    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <div
            className={cn(
              'aspect-square size-12 rounded-full flex items-center justify-center relative group transition-all duration-300 bg-gradient-to-tr from-neutral-700 to-neutral-600 border-neutral-200 dark:from-neutral-700 dark:to-neutral-600 dark:border-neutral-700'
            )}
          >
            <Image
